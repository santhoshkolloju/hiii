...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[2] + ';font-size:25px;">Special..:D:D</span><br /><br /><span style="font-size:15px;"><strong>HappieBdayTeju</strong><br /><br />Here\'s Wishing<br />A Day As Special<br />You Are<br />Happie....<br />Birthday...</span>';
...
function anotherball(){
	...
	text = document.createElement( 'div' );
	text.onSelectStart = null;
	text.innerHTML = '<span style="color:' + theme[2] + ';font-size:30px;">To The One <br> I Lyk Most</span>';
	text.style.color = theme[1];
	text.style.position = 'absolute';
	text.style.left = '0px';
	text.style.top = '0px';
	...
	text.style.left = ((190 - text.clientWidth) / 2) +'px';
	text.style.top = ((190 - text.clientHeight) / 2) +'px';	
...
function createBall( x, y ) {
	...
	element_div.width = size;
	element_div.height = size;	

	element_div.style.position = 'absolute';
	element_div.style.left = -200 + 'px';
	element_div.style.top = -200 + 'px';
	element_div.style.cursor = "default";

	canvas.appendChild(element_div);
	...
	text = document.createElement( 'div' );
	text.onSelectStart = null;
	text.innerHTML = '<span style="color:' + theme[(Math.random() * 4 >> 0) + 1] + ';font-size:40px;">Happie Bday ....<br>Teju</span>';
	text.style.color = theme[1];
	...
	circle.restitution = 0.3;
	b2body.AddShape(circle);
	b2body.userData = {element: element_div};
